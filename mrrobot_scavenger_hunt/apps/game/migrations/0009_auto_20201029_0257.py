...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL(
            ...
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (2, 'No es arepa','Voy a comer _ _ _ _ _ paisa', 'arroz', 'Completa la frase');
            ...
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (5, 'Gobierno / ideología','mnomoiscu', 'comunismo', 'Ordenar Letras');
            ...
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (7, 'Visual','El _ _ _ _ se usa para llamar la atención', 'rojo', 'Completa la frase');
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (8, 'Mitología / Animal','anrdog', 'dragon', 'Ordenar Letras');
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (9, 'Arte (2P)','धゅञѠ Ѣゅ', 'kung fu', 'Alfabeto');
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (10, 'Fenómeno demográfico','scaebloonropbi', 'sobrepoblacion', 'Ordenar Letras');
            ...
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (12, 'Efímero','En el corazón, la vida. En la piel, el _ _ _ _ _ _.', 'tiempo', 'Completa la frase');
            ...
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (15, 'Deporte extremo','pdiascraaa', 'paracaidas', 'Ordenar Letras');
            ...
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (17, 'Nooooo','Yo soy tu _ _ _ _ _.', 'padre', 'Completa la frase');
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (18, 'Enfermedad / Inflamación','iseiictapdn', 'apendicitis', 'Ordenar Letras');
            ...
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (22, 'Obligación','Esa _ _ _ _ _ es una culebra que mata.', 'deuda', 'Completa la frase');
            ...
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (25, 'Tecnología','mctoarpoud', 'computador', 'Ordenar Letras');
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (26, 'Política (2P)','円ਡデ ラでい-ラゅञѠ', 'mao tse-tung', 'Alfabeto');
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (27, 'Anime','Te voy a mostrar el 25% de mi máximo _ _ _ _ _.', 'poder', 'Completa la frase');
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (28, 'Actividad / Dinero','oioescgn', 'negocios', 'Ordenar Letras');
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (29, 'Ganador','фञѢфえラヅਡょデ', 'infiltrado', 'Alfabeto');
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (30, 'Profesión / Código','romadrgproa', 'programador', 'Ordenar Letras');
            ...
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (32, 'Revista','El _ _ _ _ _ _ es cochino, pero lo necesitamos.', 'dinero', 'Completa la frase');
            ...
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (37, 'Para ver estrellas','Los hongos, las _ _ _ _ _ _ más buscadas por Lili', 'drogas', 'Completa la frase');
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (38, 'Psicología','ਡえゅぎфञਡぎфデञ', 'alucinacion', 'Alfabeto');
            insert into game_puzzle (id, tip, description, answer, puzzle_type) values (39, 'Fenómeno ambiental','octinmnaainoc', 'contaminacion', 'Ordenar Letras');
            ...
            insert into game_attack (id, attack_uuid, title, description, evidence_type) VALUES (4, 'ca8e6ccc-7fd2-90bb-4150-1b6f85f85fb9', 'Receta creativa', 'Ve a la cocina y toma 4 productos líquidos al azar (el agua no cuenta). Revuélvelos y bebe la mezcla sin escupir. Debes grabar el proceso de la mezcla hasta la bebida incluída.', 'Video');
            ...
            insert into game_attack (id, attack_uuid, title, description, evidence_type) VALUES (10, 'e112b11d-b15d-30f3-d1f4-2f6b215b0edb', 'Encholar el ping pong', 'Mueve un ping pong mediante soplidos usando el cilindro de cartón. El ping pong debe ir de un extremo del comedor hasta el otro extremo y ser encholado en el vaso. No puedes usar las manos. Graba todo el proceso.', 'Video');
            ...
            insert into game_attack (id, attack_uuid, title, description, evidence_type) VALUES (14, 'fda7a534-8fa5-209f-7e8f-04507f6ccf22', 'Habilidad dando giros', 'En el pasto al lado del camino de la casa a la piscina, debes dar giros, rollitos o "vuelta canela" hasta terminar el camino.', 'Video');
            ...
            insert into game_attack (id, attack_uuid, title, description, evidence_type) VALUES (29, '58f24768-3911-c615-2fae-5b9027117bfe', 'Mascarilla frutal', 'Haz una mascarilla con el banano y aplícatela. Debes cubrir todo el rostro, excepto los ojos, por supuesto. (El banano no es para comer...)', 'Foto');
            insert into game_attack (id, attack_uuid, title, description, evidence_type) VALUES (30, 'e684bd90-f740-6fbc-3c53-42cbb29a9660', 'Canto complicado', 'Canta una canción cualquiera mientras te comes tres galletas secas, sin agua.', 'Video');
            ...
            insert into game_attack (id, attack_uuid, title, description, evidence_type) VALUES (34, 'd2d40704-bfc0-05c3-1da8-5b90a8498f41', 'Peluca creativa', 'Recolecta los materiales a tu alrededor para hacer una peluca creativa (lo que se te ocurra). Ponte la peluca y envía la selfie correspondiente.', 'Foto');
            ...
            insert into game_attack (id, attack_uuid, title, description, evidence_type) VALUES (39, '865229c7-7d00-36b2-56d3-78900fd99df6', 'Moldeando con plastilina', 'Con plastilina de diferentes colores, haz una moto y una persona montada en ella, simulando que la moto está en movimiento, es decir, la persona va manejando. Recuerda que el casco es obligatorio.', 'Foto');
            insert into game_attack (id, attack_uuid, title, description, evidence_type) VALUES (40, '006a787b-ac7c-f6b7-af39-ca98f7c31793', 'Rimas a la carrera', 'Debes componer 2 rimas cortas de dos frases/versos, usando las palabras "paseo" y "bosque".  Ejemplo con "camisa" y "zapato":  «Mi mamá me regaló una CAMISA, con la que siempre voy a misa. Mi papá se quitó un ZAPATO y empezó a oler a gato.»', 'Video');
